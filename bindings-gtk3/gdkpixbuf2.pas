...
begin
  Result := GdkPixbuf2.gdk_pixbuf_new_from_inline(data_length, data, copy_pixels, error);
end;
...
begin
  Result := GdkPixbuf2.gdk_pixbuf_from_pixdata(pixdata, copy_pixels, error);
end;
...
begin
  Result := GdkPixbuf2.gdk_pixdata_deserialize(@self, stream_length, stream, error);
end;
