...
const
  {$ifdef MsWindows}
  GdkPixbuf2_library = 'libgdk_pixbuf-2.0.so.dll';
  {$else}
...
type
  TGdkPixbufFormatFlags = DWord;
const
  { GdkPixbufFormatFlags }
  GDK_PIXBUF_FORMAT_WRITABLE: TGdkPixbufFormatFlags = 1;
  GDK_PIXBUF_FORMAT_SCALABLE: TGdkPixbufFormatFlags = 2;
  GDK_PIXBUF_FORMAT_THREADSAFE: TGdkPixbufFormatFlags = 4;
type
...
function gdk_pixbuf_add_alpha(pixbuf: PGdkPixbuf; substitute_color: gboolean; r: guint8; g: guint8; b: guint8): PGdkPixbuf; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_add_alpha'{$endif};
function gdk_pixbuf_animation_get_height(animation: PGdkPixbufAnimation): gint; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_animation_get_height'{$endif};
function gdk_pixbuf_animation_get_iter(animation: PGdkPixbufAnimation; start_time: PGTimeVal): PGdkPixbufAnimationIter; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_animation_get_iter'{$endif};
function gdk_pixbuf_animation_get_static_image(animation: PGdkPixbufAnimation): PGdkPixbuf; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_animation_get_static_image'{$endif};
function gdk_pixbuf_animation_get_type: TGType; cdecl; external {$ifdef MSWindows} GdkPixbuf2_library name 'gdk_pixbuf_animation_get_type' {$endif};
function gdk_pixbuf_animation_get_width(animation: PGdkPixbufAnimation): gint; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_animation_get_width'{$endif};
function gdk_pixbuf_animation_is_static_image(animation: PGdkPixbufAnimation): gboolean; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_animation_is_static_image'{$endif};
function gdk_pixbuf_animation_iter_advance(iter: PGdkPixbufAnimationIter; current_time: PGTimeVal): gboolean; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_animation_iter_advance'{$endif};
function gdk_pixbuf_animation_iter_get_delay_time(iter: PGdkPixbufAnimationIter): gint; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_animation_iter_get_delay_time'{$endif};
function gdk_pixbuf_animation_iter_get_pixbuf(iter: PGdkPixbufAnimationIter): PGdkPixbuf; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_animation_iter_get_pixbuf'{$endif};
function gdk_pixbuf_animation_iter_get_type: TGType; cdecl; external {$ifdef MSWindows} GdkPixbuf2_library name 'gdk_pixbuf_animation_iter_get_type' {$endif};
function gdk_pixbuf_animation_iter_on_currently_loading_frame(iter: PGdkPixbufAnimationIter): gboolean; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_animation_iter_on_currently_loading_frame'{$endif};
function gdk_pixbuf_animation_new_from_file(filename: Pgchar; error: PPGError): PGdkPixbufAnimation; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_animation_new_from_file'{$endif};
function gdk_pixbuf_animation_new_from_resource(resource_path: Pgchar; error: PPGError): PGdkPixbufAnimation; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_animation_new_from_resource'{$endif};
function gdk_pixbuf_animation_new_from_stream(stream: PGInputStream; cancellable: PGCancellable; error: PPGError): PGdkPixbufAnimation; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_animation_new_from_stream'{$endif};
function gdk_pixbuf_animation_new_from_stream_finish(async_result: PGAsyncResult; error: PPGError): PGdkPixbufAnimation; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_animation_new_from_stream_finish'{$endif};
function gdk_pixbuf_apply_embedded_orientation(src: PGdkPixbuf): PGdkPixbuf; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_apply_embedded_orientation'{$endif};
function gdk_pixbuf_calculate_rowstride(colorspace: TGdkColorspace; has_alpha: gboolean; bits_per_sample: gint; width: gint; height: gint): gint; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_calculate_rowstride'{$endif};
function gdk_pixbuf_composite_color_simple(src: PGdkPixbuf; dest_width: gint; dest_height: gint; interp_type: TGdkInterpType; overall_alpha: gint; check_size: gint; color1: guint32; color2: guint32): PGdkPixbuf; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_composite_color_simple'{$endif};
function gdk_pixbuf_copy(pixbuf: PGdkPixbuf): PGdkPixbuf; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_copy'{$endif};
function gdk_pixbuf_copy_options(src_pixbuf: PGdkPixbuf; dest_pixbuf: PGdkPixbuf): gboolean; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_copy_options'{$endif};
function gdk_pixbuf_error_quark: TGQuark; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_error_quark'{$endif};
function gdk_pixbuf_flip(src: PGdkPixbuf; horizontal: gboolean): PGdkPixbuf; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_flip'{$endif};
function gdk_pixbuf_format_copy(format: PGdkPixbufFormat): PGdkPixbufFormat; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_format_copy'{$endif};
function gdk_pixbuf_format_get_description(format: PGdkPixbufFormat): Pgchar; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_format_get_description'{$endif};
function gdk_pixbuf_format_get_extensions(format: PGdkPixbufFormat): PPgchar; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_format_get_extensions'{$endif};
function gdk_pixbuf_format_get_license(format: PGdkPixbufFormat): Pgchar; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_format_get_license'{$endif};
function gdk_pixbuf_format_get_mime_types(format: PGdkPixbufFormat): PPgchar; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_format_get_mime_types'{$endif};
function gdk_pixbuf_format_get_name(format: PGdkPixbufFormat): Pgchar; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_format_get_name'{$endif};
function gdk_pixbuf_format_get_type: TGType; cdecl; external {$ifdef MSWindows} GdkPixbuf2_library name 'gdk_pixbuf_format_get_type' {$endif};
function gdk_pixbuf_format_is_disabled(format: PGdkPixbufFormat): gboolean; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_format_is_disabled'{$endif};
function gdk_pixbuf_format_is_save_option_supported(format: PGdkPixbufFormat; option_key: Pgchar): gboolean; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_format_is_save_option_supported'{$endif};
function gdk_pixbuf_format_is_scalable(format: PGdkPixbufFormat): gboolean; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_format_is_scalable'{$endif};
function gdk_pixbuf_format_is_writable(format: PGdkPixbufFormat): gboolean; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_format_is_writable'{$endif};
function gdk_pixbuf_get_bits_per_sample(pixbuf: PGdkPixbuf): gint; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_get_bits_per_sample'{$endif};
function gdk_pixbuf_get_byte_length(pixbuf: PGdkPixbuf): gsize; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_get_byte_length'{$endif};
function gdk_pixbuf_get_colorspace(pixbuf: PGdkPixbuf): TGdkColorspace; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_get_colorspace'{$endif};
function gdk_pixbuf_get_file_info(filename: Pgchar; width: Pgint; height: Pgint): PGdkPixbufFormat; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_get_file_info'{$endif};
function gdk_pixbuf_get_file_info_finish(async_result: PGAsyncResult; width: Pgint; height: Pgint; error: PPGError): PGdkPixbufFormat; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_get_file_info_finish'{$endif};
function gdk_pixbuf_get_formats: PGSList; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_get_formats'{$endif};
function gdk_pixbuf_get_has_alpha(pixbuf: PGdkPixbuf): gboolean; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_get_has_alpha'{$endif};
function gdk_pixbuf_get_height(pixbuf: PGdkPixbuf): gint; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_get_height'{$endif};
function gdk_pixbuf_get_n_channels(pixbuf: PGdkPixbuf): gint; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_get_n_channels'{$endif};
function gdk_pixbuf_get_option(pixbuf: PGdkPixbuf; key: Pgchar): Pgchar; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_get_option'{$endif};
function gdk_pixbuf_get_options(pixbuf: PGdkPixbuf): PGHashTable; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_get_options'{$endif};
function gdk_pixbuf_get_pixels(pixbuf: PGdkPixbuf): Pguint8; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_get_pixels'{$endif};
function gdk_pixbuf_get_pixels_with_length(pixbuf: PGdkPixbuf; length: Pguint): Pguint8; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_get_pixels_with_length'{$endif};
function gdk_pixbuf_get_rowstride(pixbuf: PGdkPixbuf): gint; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_get_rowstride'{$endif};
function gdk_pixbuf_get_type: TGType; cdecl; external {$ifdef MSWindows} GdkPixbuf2_library name 'gdk_pixbuf_get_type' {$endif};
function gdk_pixbuf_get_width(pixbuf: PGdkPixbuf): gint; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_get_width'{$endif};
function gdk_pixbuf_init_modules(path: Pgchar; error: PPGError): gboolean; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_init_modules'{$endif};
function gdk_pixbuf_loader_close(loader: PGdkPixbufLoader; error: PPGError): gboolean; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_loader_close'{$endif};
function gdk_pixbuf_loader_get_animation(loader: PGdkPixbufLoader): PGdkPixbufAnimation; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_loader_get_animation'{$endif};
function gdk_pixbuf_loader_get_format(loader: PGdkPixbufLoader): PGdkPixbufFormat; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_loader_get_format'{$endif};
function gdk_pixbuf_loader_get_pixbuf(loader: PGdkPixbufLoader): PGdkPixbuf; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_loader_get_pixbuf'{$endif};
function gdk_pixbuf_loader_get_type: TGType; cdecl; external {$ifdef MSWindows} GdkPixbuf2_library name 'gdk_pixbuf_loader_get_type' {$endif};
function gdk_pixbuf_loader_new: PGdkPixbufLoader; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_loader_new'{$endif};
function gdk_pixbuf_loader_new_with_mime_type(mime_type: Pgchar; error: PPGError): PGdkPixbufLoader; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_loader_new_with_mime_type'{$endif};
function gdk_pixbuf_loader_new_with_type(image_type: Pgchar; error: PPGError): PGdkPixbufLoader; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_loader_new_with_type'{$endif};
function gdk_pixbuf_loader_write(loader: PGdkPixbufLoader; buf: Pguint8; count: gsize; error: PPGError): gboolean; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_loader_write'{$endif};
function gdk_pixbuf_loader_write_bytes(loader: PGdkPixbufLoader; buffer: PGBytes; error: PPGError): gboolean; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_loader_write_bytes'{$endif};
function gdk_pixbuf_new(colorspace: TGdkColorspace; has_alpha: gboolean; bits_per_sample: gint; width: gint; height: gint): PGdkPixbuf; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_new'{$endif};
function gdk_pixbuf_new_from_bytes(data: PGBytes; colorspace: TGdkColorspace; has_alpha: gboolean; bits_per_sample: gint; width: gint; height: gint; rowstride: gint): PGdkPixbuf; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_new_from_bytes'{$endif};
function gdk_pixbuf_new_from_data(data: Pguint8; colorspace: TGdkColorspace; has_alpha: gboolean; bits_per_sample: gint; width: gint; height: gint; rowstride: gint; destroy_fn: TGdkPixbufDestroyNotify; destroy_fn_data: gpointer): PGdkPixbuf; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_new_from_data'{$endif};
function gdk_pixbuf_new_from_file(filename: Pgchar; error: PPGError): PGdkPixbuf; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_new_from_file'{$endif};
function gdk_pixbuf_new_from_file_at_scale(filename: Pgchar; width: gint; height: gint; preserve_aspect_ratio: gboolean; error: PPGError): PGdkPixbuf; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_new_from_file_at_scale'{$endif};
function gdk_pixbuf_new_from_file_at_size(filename: Pgchar; width: gint; height: gint; error: PPGError): PGdkPixbuf; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_new_from_file_at_size'{$endif};
function gdk_pixbuf_new_from_resource(resource_path: Pgchar; error: PPGError): PGdkPixbuf; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_new_from_resource'{$endif};
function gdk_pixbuf_new_from_resource_at_scale(resource_path: Pgchar; width: gint; height: gint; preserve_aspect_ratio: gboolean; error: PPGError): PGdkPixbuf; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_new_from_resource_at_scale'{$endif};
function gdk_pixbuf_new_from_stream(stream: PGInputStream; cancellable: PGCancellable; error: PPGError): PGdkPixbuf; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_new_from_stream'{$endif};
function gdk_pixbuf_new_from_stream_at_scale(stream: PGInputStream; width: gint; height: gint; preserve_aspect_ratio: gboolean; cancellable: PGCancellable; error: PPGError): PGdkPixbuf; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_new_from_stream_at_scale'{$endif};
function gdk_pixbuf_new_from_stream_finish(async_result: PGAsyncResult; error: PPGError): PGdkPixbuf; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_new_from_stream_finish'{$endif};
function gdk_pixbuf_new_from_xpm_data(data: PPgchar): PGdkPixbuf; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_new_from_xpm_data'{$endif};
function gdk_pixbuf_new_subpixbuf(src_pixbuf: PGdkPixbuf; src_x: gint; src_y: gint; width: gint; height: gint): PGdkPixbuf; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_new_subpixbuf'{$endif};
function gdk_pixbuf_non_anim_get_type: TGType; cdecl; external {$ifdef MSWindows} GdkPixbuf2_library name 'gdk_pixbuf_non_anim_get_type' {$endif};
function gdk_pixbuf_non_anim_new(pixbuf: PGdkPixbuf): PGdkPixbufNonAnim; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_non_anim_new'{$endif};
function gdk_pixbuf_read_pixel_bytes(pixbuf: PGdkPixbuf): PGBytes; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_read_pixel_bytes'{$endif};
function gdk_pixbuf_read_pixels(pixbuf: PGdkPixbuf): Pguint8; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_read_pixels'{$endif};
function gdk_pixbuf_remove_option(pixbuf: PGdkPixbuf; key: Pgchar): gboolean; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_remove_option'{$endif};
function gdk_pixbuf_rotate_simple(src: PGdkPixbuf; angle: TGdkPixbufRotation): PGdkPixbuf; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_rotate_simple'{$endif};
function gdk_pixbuf_save(pixbuf: PGdkPixbuf; filename: Pgchar; type_: Pgchar; error: PPGError; args: array of const): gboolean; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_save'{$endif};
function gdk_pixbuf_save_to_buffer(pixbuf: PGdkPixbuf; buffer: PPgchar; buffer_size: Pgsize; type_: Pgchar; error: PPGError; args: array of const): gboolean; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_save_to_buffer'{$endif};
function gdk_pixbuf_save_to_bufferv(pixbuf: PGdkPixbuf; buffer: PPgchar; buffer_size: Pgsize; type_: Pgchar; option_keys: PPgchar; option_values: PPgchar; error: PPGError): gboolean; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_save_to_bufferv'{$endif};
function gdk_pixbuf_save_to_callback(pixbuf: PGdkPixbuf; save_func: TGdkPixbufSaveFunc; user_data: gpointer; type_: Pgchar; error: PPGError; args: array of const): gboolean; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_save_to_callback'{$endif};
function gdk_pixbuf_save_to_callbackv(pixbuf: PGdkPixbuf; save_func: TGdkPixbufSaveFunc; user_data: gpointer; type_: Pgchar; option_keys: PPgchar; option_values: PPgchar; error: PPGError): gboolean; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_save_to_callbackv'{$endif};
function gdk_pixbuf_save_to_stream(pixbuf: PGdkPixbuf; stream: PGOutputStream; type_: Pgchar; cancellable: PGCancellable; error: PPGError; args: array of const): gboolean; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_save_to_stream'{$endif};
function gdk_pixbuf_save_to_stream_finish(async_result: PGAsyncResult; error: PPGError): gboolean; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_save_to_stream_finish'{$endif};
function gdk_pixbuf_save_to_streamv(pixbuf: PGdkPixbuf; stream: PGOutputStream; type_: Pgchar; option_keys: PPgchar; option_values: PPgchar; cancellable: PGCancellable; error: PPGError): gboolean; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_save_to_streamv'{$endif};
function gdk_pixbuf_savev(pixbuf: PGdkPixbuf; filename: Pgchar; type_: Pgchar; option_keys: PPgchar; option_values: PPgchar; error: PPGError): gboolean; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_savev'{$endif};
function gdk_pixbuf_scale_simple(src: PGdkPixbuf; dest_width: gint; dest_height: gint; interp_type: TGdkInterpType): PGdkPixbuf; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_scale_simple'{$endif};
function gdk_pixbuf_set_option(pixbuf: PGdkPixbuf; key: Pgchar; value: Pgchar): gboolean; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_set_option'{$endif};
function gdk_pixbuf_simple_anim_get_loop(animation: PGdkPixbufSimpleAnim): gboolean; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_simple_anim_get_loop'{$endif};
function gdk_pixbuf_simple_anim_get_type: TGType; cdecl; external {$ifdef MSWindows} GdkPixbuf2_library name 'gdk_pixbuf_simple_anim_get_type' {$endif};
function gdk_pixbuf_simple_anim_iter_get_type: TGType; cdecl; external {$ifdef MSWindows} GdkPixbuf2_library name 'gdk_pixbuf_simple_anim_iter_get_type' {$endif};
function gdk_pixbuf_simple_anim_new(width: gint; height: gint; rate: gfloat): PGdkPixbufSimpleAnim; cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_simple_anim_new'{$endif};
procedure gdk_pixbuf_animation_new_from_stream_async(stream: PGInputStream; cancellable: PGCancellable; callback: TGAsyncReadyCallback; user_data: gpointer); cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_animation_new_from_stream_async'{$endif};
procedure gdk_pixbuf_composite(src: PGdkPixbuf; dest: PGdkPixbuf; dest_x: gint; dest_y: gint; dest_width: gint; dest_height: gint; offset_x: gdouble; offset_y: gdouble; scale_x: gdouble; scale_y: gdouble; interp_type: TGdkInterpType; overall_alpha: gint); cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_composite'{$endif};
procedure gdk_pixbuf_composite_color(src: PGdkPixbuf; dest: PGdkPixbuf; dest_x: gint; dest_y: gint; dest_width: gint; dest_height: gint; offset_x: gdouble; offset_y: gdouble; scale_x: gdouble; scale_y: gdouble; interp_type: TGdkInterpType; overall_alpha: gint; check_x: gint; check_y: gint; check_size: gint; color1: guint32; color2: guint32); cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_composite_color'{$endif};
procedure gdk_pixbuf_copy_area(src_pixbuf: PGdkPixbuf; src_x: gint; src_y: gint; width: gint; height: gint; dest_pixbuf: PGdkPixbuf; dest_x: gint; dest_y: gint); cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_copy_area'{$endif};
procedure gdk_pixbuf_fill(pixbuf: PGdkPixbuf; pixel: guint32); cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_fill'{$endif};
procedure gdk_pixbuf_format_free(format: PGdkPixbufFormat); cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_format_free'{$endif};
procedure gdk_pixbuf_format_set_disabled(format: PGdkPixbufFormat; disabled: gboolean); cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_format_set_disabled'{$endif};
procedure gdk_pixbuf_get_file_info_async(filename: Pgchar; cancellable: PGCancellable; callback: TGAsyncReadyCallback; user_data: gpointer); cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_get_file_info_async'{$endif};
procedure gdk_pixbuf_loader_set_size(loader: PGdkPixbufLoader; width: gint; height: gint); cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_loader_set_size'{$endif};
procedure gdk_pixbuf_new_from_stream_async(stream: PGInputStream; cancellable: PGCancellable; callback: TGAsyncReadyCallback; user_data: gpointer); cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_new_from_stream_async'{$endif};
procedure gdk_pixbuf_new_from_stream_at_scale_async(stream: PGInputStream; width: gint; height: gint; preserve_aspect_ratio: gboolean; cancellable: PGCancellable; callback: TGAsyncReadyCallback; user_data: gpointer); cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_new_from_stream_at_scale_async'{$endif};
procedure gdk_pixbuf_saturate_and_pixelate(src: PGdkPixbuf; dest: PGdkPixbuf; saturation: gfloat; pixelate: gboolean); cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_saturate_and_pixelate'{$endif};
procedure gdk_pixbuf_save_to_stream_async(pixbuf: PGdkPixbuf; stream: PGOutputStream; type_: Pgchar; cancellable: PGCancellable; callback: TGAsyncReadyCallback; user_data: gpointer; args: array of const); cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_save_to_stream_async'{$endif};
procedure gdk_pixbuf_save_to_streamv_async(pixbuf: PGdkPixbuf; stream: PGOutputStream; type_: Pgchar; option_keys: PPgchar; option_values: PPgchar; cancellable: PGCancellable; callback: TGAsyncReadyCallback; user_data: gpointer); cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_save_to_streamv_async'{$endif};
procedure gdk_pixbuf_scale(src: PGdkPixbuf; dest: PGdkPixbuf; dest_x: gint; dest_y: gint; dest_width: gint; dest_height: gint; offset_x: gdouble; offset_y: gdouble; scale_x: gdouble; scale_y: gdouble; interp_type: TGdkInterpType); cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_scale'{$endif};
procedure gdk_pixbuf_simple_anim_add_frame(animation: PGdkPixbufSimpleAnim; pixbuf: PGdkPixbuf); cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_simple_anim_add_frame'{$endif};
procedure gdk_pixbuf_simple_anim_set_loop(animation: PGdkPixbufSimpleAnim; loop: gboolean); cdecl; external {$ifdef Mswindows}GdkPixbuf2_library  name 'gdk_pixbuf_simple_anim_set_loop'{$endif};
implementation
...
begin
  Result := GdkPixbuf2.gdk_pixbuf_init_modules(path, error);
end;
...
begin
  Result := GdkPixbuf2.gdk_pixbuf_non_anim_new(pixbuf);
end;
